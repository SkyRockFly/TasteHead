...
(1, (SELECT id FROM image_hash WHERE hash = 'kekeke2'), 'lol2.png', 0.75, 0.75,'2026-04-12 18:30:00'),
(1, (SELECT id FROM image_hash WHERE hash = 'kekeke3'), 'lol3.png', 0.5, 0.50, '2026-04-12 18:30:00'),
(1, (SELECT id FROM image_hash WHERE hash = 'kekeke4'), 'lol4.png', 0.25, 0.25, '2026-04-12 18:30:00'),
