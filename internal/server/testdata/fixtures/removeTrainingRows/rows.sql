...
(1, (SELECT id FROM image_hash WHERE hash = 'kekeke5'), 'lol5.png', 0.0, 0.0, NULL);

INSERT INTO tag (name) VALUES ('version1');

INSERT INTO training (image_id,tag_id,deleted_at) VALUES
(1,1,NULL),
(2,1,NULL),
(3,1,NULL),
(4,1,NULL),
(5,1,'2026-04-12 18:30:00');
